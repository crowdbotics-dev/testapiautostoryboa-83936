...
## Project Structure
    ...
    ├── testapiautostoryboa_83936  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_83936`
...
2. Clone this repo and `cd testapiautostoryboa_83936`
